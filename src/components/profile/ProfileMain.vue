  ...
  <div class="webpage-link-container">
    ...
    <div class="d-flex flex-wrap">
      <div v-for="(webSmList, i) in webIconUrl" :key="i">
        <!-- git hub -->
        <a
          v-if="profiletUser[webSmList[0]]"
          class="webpage-link-box"
          :href="profiletUser[webSmList[0]]"
        >
          <img
            :src="webSmList[1]"
...
export default {
  ...
  setup() {
    ...
    const webIconUrl = [
      ...
      ["notion", "https://img.icons8.com/ios/500/notion.png"],
      ["etc", "https://pic.onlinewebfonts.com/svg/img_229126.png"],
    ];
